...
// navigated to. WebKit reports that URL both for the injected page and for the reload that
// replaces it with the directory itself, so a load of any other URL is a page the plugin linked to.
